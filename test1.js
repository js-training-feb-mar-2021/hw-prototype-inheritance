...
Order.prototype.calculatePrice = function () {
    return this.params.dishes
        .map(dish => dish.calculatePrice())
        .reduce((totalPrice, addPrice) => totalPrice + addPrice)
...
Order.prototype.calculateCalories = function () {
    return this.params.dishes
        ...
        .reduce((totalCalories, addCalorie) => totalCalories + addCalorie)

} 

Order.prototype.addDish = function(dish) {
if (this.params.paid === true) {alert("ORDER IS SERVED")} else {
...
console.log(order.getOptions());
console.log(order.params.paid);